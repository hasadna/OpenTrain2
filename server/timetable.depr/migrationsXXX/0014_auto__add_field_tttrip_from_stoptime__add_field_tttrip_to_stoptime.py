...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column(u'timetable_tttrip', 'from_stoptime',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='first_stop', null=True,
                                                                            to=orm['timetable.TtStopTime']),
                      keep_default=False)

        # Adding field 'TtTrip.to_stoptime'
        db.add_column(u'timetable_tttrip', 'to_stoptime',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='last_stop', null=True,
                                                                            to=orm['timetable.TtStopTime']),
                      keep_default=False)
    ...
    models = {
        ...
        u'timetable.tttrip': {
            ...
            'from_stoptime': ('django.db.models.fields.related.ForeignKey', [],
                              {'related_name': "'first_stop'", 'null': 'True', 'to': u"orm['timetable.TtStopTime']"}),
            'gtfs_trip_id': ('django.db.models.fields.CharField', [],
                             {'db_index': 'True', 'max_length': '100', 'unique': 'True', 'null': 'True',
                              'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'shape': (
            'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['timetable.TtShape']", 'null': 'True'}),
            'to_stoptime': ('django.db.models.fields.related.ForeignKey', [],
                            {'related_name': "'last_stop'", 'null': 'True', 'to': u"orm['timetable.TtStopTime']"})
        }
    }
