...
def generate_mock_reports(device_id='fake_device_1', trip_id='010714_00115', day=None, from_stop_id=None,
                          to_stop_id=None, nostop_percent=0.2, station_radius_in_meters=300):
    ...
    for coord, stop_id, i in zip(coords, stop_ids, xrange(len(stop_ids))):
        ...
        timestamp = interval_start + datetime.timedelta(
            seconds=interval_ratio * (interval_end - interval_start).total_seconds())
